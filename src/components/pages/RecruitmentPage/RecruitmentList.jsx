...
import RecruitmentComments from "./RecruitmentComments"; // Import component mới
...
export default function PublicRecruitmentList() {
  ...
  const filterData = () => {
    let filtered = data.filter((post) => {
      ...
      const matchesExperience =
        experienceFilter === "all" || post.experienceLevel === experienceFilter;
  ...
  const navigateToLeaderProfile = (leaderId) => {
    if (leaderId && leaderId !== "undefined") {
      ...
      console.warn(
        "RecruitmentList - Cannot navigate: leaderId is undefined or invalid"
      );
  ...
  const isDeadlineNear = (deadline) => {
    return (
      deadline &&
      dayjs(deadline).isBefore(dayjs().add(3, "day")) &&
        ...
        {filteredData.length === 0 ? (
          ...
          <div className="space-y-5">
            {filteredData.map((item) => {
              const commentsExpanded = expandedComments.has(item._id);
              ...
              return (
                ...
                >
                  <div className="p-6">
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            <h4
                              ...
                              onClick={() =>
                                navigateToLeaderProfile(item.leaderId)
                              }
                            >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Tag
                              color={getExperienceColor(item.experienceLevel)}
                              className="experience-tag-modern"
                            >
                    ...
                    {/* Image Section */}
                    {item.recruitmentLinkToImages &&
                      item.recruitmentLinkToImages.length > 0 && (
                    ...
                    <div className="action-section-modern">
                      ...
                      <Button
                        ...
                        className="action-button-modern"
                      >
                        {commentsExpanded ? "Ẩn bình luận" : "Xem bình luận"}
                      </Button>
