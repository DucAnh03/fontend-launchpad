...
import React, { createContext, useContext, useEffect, useState, useRef } from 'react'; // Thêm useRef
    ...
    useEffect(() => {
        ...
        if (user && token) {
            ...
            newSocket.on('receiveMessage', (messageData) => {
                ...
                receiveMessageCallbacks.current.forEach(callback => callback(messageData));
